function ReturnRow({ custNum, custName, catNum, colNum, meter, date }) {
  return (
    <>
      <div className="grid w-full grid-cols-6 border-gray-400 border-spacing-1 border bg-backclr text-white">
        <h1>{custName}</h1>
        <h1>{custNum}</h1>
        <h1>{catNum}</h1>
        <h1>{colNum}</h1>
