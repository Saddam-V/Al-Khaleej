...
function ButtonGroupCat() {
  ...
  async function searchFunc() {
    ...
    await navigate("/catalogue/search/" + document.getElementById("simple-search").value);
    // document.getElementById("simple-search").value = " ";
  }

  function applyFilter() {
    if (orderInput.current.value === "AS") {
      navigate("/catalogue/" + textInput.current.value);
    } else {
      const qry = "-" + textInput.current.value.toString();
      console.log(qry);
      navigate("/catalogue/" + qry);
    }
  }
      ...
      <div className="flex flex-row justify-around">
        ...
        <div>
          ...
          >
            ...
            <option value="catName">Catalogue Name</option>
