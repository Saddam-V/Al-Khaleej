...
function ButtonGroupCust() {
  ...
  async function searchFunc() {
    ...
    await navigate("/customer/search/" + document.getElementById("simple-search").value);
    // document.getElementById("simple-search").value = " ";
  }

  function applyFilter() {
    if (orderInput.current.value === "AS") {
      navigate("/customer/" + textInput.current.value);
    } else {
      const qry = "-" + textInput.current.value.toString();
      console.log(qry);
      navigate("/customer/" + qry);
    }
  }
...
export default ButtonGroupCust;
