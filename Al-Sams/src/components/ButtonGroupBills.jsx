...
function ButtonGroupBills() {
  ...
  async function searchFunc() {
    ...
    await navigate("/billHistory/search/" + document.getElementById("simple-search").value);
    // document.getElementById("simple-search").value = " ";
  }
  function applyFilter() {
    if (orderInput.current.value === "AS") {
      navigate("/billHistory/" + textInput.current.value);
    } else {
      const qry = "-" + textInput.current.value.toString();
      console.log(qry);
      navigate("/billHistory/" + qry);
    }
  }
...
export default ButtonGroupBills;
